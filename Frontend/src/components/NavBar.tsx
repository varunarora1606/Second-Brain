...
function NavBar() {
  ...
  const handleShareBrain = async() => {
    ...
    navigator.clipboard.writeText(`http://localhost:5173/brain/${response.data.data.hash}`)
  }
  ...
  return (
    <div className="sticky top-0 w-full bg-white py-5 pr-15 pl-10 flex justify-between items-center z-999">
      ...
      <div className="flex gap-7.5">
        <Button variant="secondary" text="Share Brain" onClick={handleShareBrain} startIcon={<Share />} />
